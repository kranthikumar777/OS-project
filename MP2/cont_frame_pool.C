                             ...
                             unsigned long _n_info_frames)
{
	...
	//Bitmap uses two bits per frame
	//11 --> free frame
	//00 --> Head of sequence and allocated frame
	//01 --> Allocated frame
	if(info_frame_no == 0){
